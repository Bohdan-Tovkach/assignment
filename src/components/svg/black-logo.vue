<template>
<span>
<svg width="133px" height="24px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 133.44 24.37">
	<defs></defs>
	<title>logo</title>
						...
						<g id="main--6-320">
							<g id="header">
								<g id="logo">
									...
									<g id="abz">
										<path id="Shape" class="cls-2" d="M10.71,16.45l1.3-2h0L20.26,1.87H3.77l3.86,5.9-1.29,2L0,0H24L12,18.42l-1.29-2Zm2.58-8.89-1.3,2h0L3.74,22.13H20.23l-3.86-5.9,1.29-2L24,24H0L12,5.59l1.29,2Z"/>
									</g>
								</g>
							</g>
						</g>
